...
import ProductMteSection from "../../../components/organisms/product-mte-section"
import { useWidgets } from "../../../providers/widget-provider"
import { getErrorStatus } from "../../../utils/get-error-status"
import {useAdminMultilingual} from "../../../hooks/multilingual/use-admin-multilingual";
...
const Edit = () => {
  ...
  const { multilingual } = useAdminMultilingual({
    relid: id,
    type: "product",
  }) || {}
  const multilingualContent = JSON.parse(multilingual?.content || '{}')
      ...
      <div className="gap-y-xsmall flex flex-col">
        ...
        <div className="gap-x-base grid grid-cols-12">
          <div className="gap-y-xsmall col-span-8 flex flex-col">
            <ProductGeneralSection multilingualContent={multilingualContent} product={product} />
            <ProductVariantsSection product={product} />
            <ProductAttributesSection product={product} />
            <ProductMteSection product={product} />
