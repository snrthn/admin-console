        ...
        {render && (
          <>
            ...
            <Accordion.Item
              ...
              className="border-b-0"
              title="折扣条件配置"
              subtitle="如果关联活动后不可叠加选项自动打开，不能编辑"
              tooltip="关于折扣优惠券的详细说明，请查看帮助中心。"
              value="activity_id"
              customTrigger={
                <Switch checked={openItems.indexOf("activity_id") > -1} />
              }
            >
            ...
            <div className="gap-x-base gap-y-base my-base flex">
              ...
              <div style={{ width: '40%'}}>
                <InputField
                  {...register("max_num", { valueAsNumber: true })}
                  label="可用于续费"
                  type="number"
                  min={1}
                />
            ...
            <div className="gap-x-base gap-y-base my-base flex">
              <div style={{ width: '40%'}}>
                <div style={{ width: '7em', display: 'inline-block'}}>可用于续费：</div>
                <Switch {...register("is_renew")} />
              </div>
              <div style={{ width: '40%'}}>
                <div style={{ width: '7em', display: 'inline-block'}}>产品升级专用：</div>
                <Switch {...register("is_upgrade")} />
              </div>
            </div>

            <div className="gap-x-base gap-y-base my-base flex">
              <div style={{ width: '40%'}}>
                <div style={{ width: '7em', display: 'inline-block'}}>不可叠加：</div>
                <Switch {...register("is_exclusive")} />
              </div>
              <div style={{ width: '40%'}}>
                <div>即：不可与其他优惠卷一起使用</div>
              </div>
            </div>
