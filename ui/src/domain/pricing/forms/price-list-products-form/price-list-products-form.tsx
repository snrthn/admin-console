...
import { useAdminProducts } from "../../../../hooks/product/use-admin-products"
...
const PriceListProductsForm = ({
  ...
  const tagSelect = product_tags?.map((tag: {id: string, value: string}) => ({
    value: tag['id'],
    label: tag['value']
  }))
  tagSelect?.unshift({
    value: "none",
    label: t("default-tag-select", "Tag Filtering")
  })
